...
export default function App() {
    ...
    return (_jsxs("main", { className: "shell app-shell", children: [_jsx("section", { className: "dashboard-toolbar", children: _jsxs("div", { className: "toolbar-meta", children: [_jsxs("div", { className: "toolbar-balance", children: [_jsx("span", { className: "metric-label", children: "Net won / lost" }), _jsx("strong", { children: formatSignedMoney(profile?.user.balance ?? 0) })] }), _jsxs("div", { className: "toolbar-actions", children: [_jsx("button", { className: "toolbar-button", type: "button", onClick: () => setSettingsOpen((current) => !current), children: settingsOpen ? "Close settings" : "Settings" }), _jsx("button", { className: "toolbar-button toolbar-button-secondary", onClick: () => logout({
                                    ...
                                    }), children: "Log out" })] })] }) }), error ? (_jsx("section", { className: "status-banner", children: _jsx("strong", { children: error }) })) : null, settingsOpen ? (_jsxs("section", { className: "settings-overlay", "aria-label": "Settings", children: [_jsx("button", { className: "settings-backdrop", type: "button", "aria-label": "Close settings", onClick: () => setSettingsOpen(false) }), _jsxs("article", { className: "panel settings-panel settings-modal", children: [_jsxs("div", { className: "panel-heading settings-modal-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "kicker", children: "Settings" }), _jsx("h2", { children: "Personal settings" })] }), _jsx("button", { className: "toolbar-button toolbar-button-secondary", type: "button", onClick: () => setSettingsOpen(false), children: "Close" })] }), _jsxs("div", { className: "settings-grid", children: [_jsxs("form", { onSubmit: handleSaveVenmoHandle, className: "form-stack compact-form", children: [_jsx("span", { className: "subtle-copy", children: "Your Venmo handle for payment instructions" }), _jsx("input", { value: venmoHandle, onChange: (event) => setVenmoHandle(event.target.value), placeholder: "@yourhandle", required: true }), _jsx("button", { className: "secondary-button", type: "submit", disabled: busyAction === "venmo", children: "Save Venmo" })] }), _jsxs("div", { className: "form-stack compact-form", children: [_jsx("span", { className: "subtle-copy", children: "Family groups" }), _jsx("strong", { children: selectedGroup ? selectedGroup.name : "No family selected" }), _jsx("p", { className: "subtle-copy", children: "Create groups, switch families, invite people, and manage members in a separate popup." }), _jsx("button", { className: "primary-button", type: "button", onClick: openFamilyManager, children: "Manage family" })] }), _jsxs("div", { className: "form-stack compact-form", children: [_jsx("span", { className: "subtle-copy", children: "Tutorial status" }), _jsx("strong", { children: profile.user.hasCompletedTutorial ? "Completed" : "Not completed yet" }), _jsx("button", { className: "toolbar-button toolbar-button-secondary", type: "button", disabled: busyAction === "tutorial-reset", onClick: () => void handleRestartTutorial(), children: "Redo tutorial" })] })] })] })] })) : null, familyManagerOpen ? (_jsxs("section", { className: "settings-overlay", "aria-label": "Manage family", children: [_jsx("button", { className: "settings-backdrop", type: "button", "aria-label": "Close family manager", onClick: () => setFamilyManagerOpen(false) }), _jsxs("article", { className: "panel settings-panel settings-modal family-manager-modal", children: [_jsxs("div", { className: "panel-heading settings-modal-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "kicker", children: "Family manager" }), _jsx("h2", { children: selectedGroup?.name ?? "Manage your families" })] }), _jsx("button", { className: "toolbar-button toolbar-button-secondary", type: "button", onClick: () => setFamilyManagerOpen(false), children: "Close" })] }), _jsxs("div", { className: "family-manager-grid", children: [_jsxs("div", { className: "family-manager-column", children: [_jsxs("div", { className: "compact-form family-summary-card", children: [_jsx("span", { className: "subtle-copy", children: "Current family" }), _jsx("strong", { children: selectedGroup?.name ?? "Choose a family group" }), _jsx("p", { className: "subtle-copy", children: selectedGroup
                                                            ? `Join code ${selectedGroup.joinCode}`
                                                            : "Create a group or join one with a code." }), _jsxs("div", { className: "family-strip-meta", children: [_jsxs("div", { className: "compact-metric", children: [_jsx("span", { className: "metric-label", children: "Members" }), _jsx("strong", { children: selectedGroup?.members.length ?? 0 })] }), _jsxs("div", { className: "compact-metric", children: [_jsx("span", { className: "metric-label", children: "Visible markets" }), _jsx("strong", { children: markets.length })] })] })] }), _jsxs("div", { className: "compact-form", children: [_jsx("span", { className: "subtle-copy", children: "Switch family" }), _jsx("div", { className: "group-selector vertical", children: profile?.groups.map((group) => (_jsxs("button", { type: "button", className: selectedGroupId === group.id ? "group-pill active" : "group-pill", onClick: () => setSelectedGroupId(group.id), children: [_jsx("span", { children: group.name }), _jsx("strong", { children: group.role }), _jsx("small", { children: group.joinCode })] }, group.id))) })] })] }), _jsxs("div", { className: "family-manager-column", children: [_jsxs("form", { onSubmit: handleCreateGroup, className: "form-stack compact-form", children: [_jsx("span", { className: "subtle-copy", children: "Create a new family group" }), _jsx("input", { value: groupName, onChange: (event) => setGroupName(event.target.value), placeholder: "The Parkers", required: true }), _jsx("button", { className: "primary-button", type: "submit", disabled: busyAction === "create-group", children: "Create group" })] }), _jsxs("form", { onSubmit: handleJoinGroup, className: "form-stack compact-form", children: [_jsx("span", { className: "subtle-copy", children: referralJoinCode ? "Invite link detected for this group" : "Join another family group" }), _jsx("input", { value: joinCode, onChange: (event) => setJoinCode(event.target.value.toUpperCase()), placeholder: "Join code", required: true }), _jsx("button", { className: "ghost-button", type: "submit", disabled: busyAction === "join-group", children: "Join group" })] }), selectedGroup ? (_jsxs("div", { className: "compact-form", children: [_jsx("span", { className: "subtle-copy", children: "Invite people" }), _jsx("strong", { children: "Copy the invite link" }), _jsx("p", { className: "subtle-copy invite-link-copy", children: selectedGroupInviteUrl }), _jsx("button", { className: "ghost-button", type: "button", onClick: () => void copyInviteLink(selectedGroup.joinCode), children: "Copy invite link" })] })) : null, selectedGroup && selectedGroup.role === "ADMIN" ? (_jsxs("div", { className: "form-stack compact-form", children: [_jsx("span", { className: "subtle-copy", children: "Manage members" }), selectedGroup.members
                                                        .filter((member) => member.id !== profile.user.id)
                                                        .map((member) => (_jsxs("div", { className: "member-card member-management-row", children: [_jsxs("div", { children: [_jsx("strong", { children: member.displayName }), _jsx("span", { children: member.role })] }), _jsx("button", { className: "ghost-button", type: "button", disabled: busyAction === `remove-member-${member.id}`, onClick: () => void handleRemoveGroupMember(selectedGroup.id, member.id, member.displayName), children: "Remove" })] }, member.id))), _jsx("button", { className: "toolbar-button toolbar-button-secondary", type: "button", disabled: busyAction === `delete-group-${selectedGroup.id}`, onClick: () => void handleDeleteGroup(selectedGroup.id, selectedGroup.name), children: "Delete family" })] })) : null] })] })] })] })) : null, _jsxs("section", { className: "dashboard-grid", children: [_jsxs("aside", { className: "sidebar-stack", children: [_jsxs("article", { className: "panel family-strip family-panel", children: [_jsxs("div", { className: "panel-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "kicker", children: "Current family" }), _jsx("h2", { children: selectedGroup?.name ?? "Choose a family group" })] }), _jsx("button", { className: "toolbar-button toolbar-button-secondary", type: "button", onClick: openFamilyManager, children: "Manage family" })] }), _jsxs("div", { className: "family-strip-meta", children: [_jsxs("div", { className: "compact-metric", children: [_jsx("span", { className: "metric-label", children: "Members" }), _jsx("strong", { children: selectedGroup?.members.length ?? 0 })] }), _jsxs("div", { className: "compact-metric", children: [_jsx("span", { className: "metric-label", children: "Visible markets" }), _jsx("strong", { children: markets.length })] })] }), _jsxs("div", { className: "compact-form family-summary-card", children: [_jsx("span", { className: "subtle-copy", children: "Family summary" }), _jsx("strong", { children: selectedGroup?.role ?? "No active role" }), _jsx("p", { className: "subtle-copy", children: selectedGroup
                                                    ? `Join code ${selectedGroup.joinCode}. Use Manage family for switching groups, invites, and member controls.`
                                                    : "Open Manage family to create or join your first group." })] })] }), _jsxs("article", { className: "panel leaderboard-panel", children: [_jsx("div", { className: "panel-heading", children: _jsxs("div", { children: [_jsx("p", { className: "kicker", children: "Members" }), _jsx("h2", { children: "Win / loss board" })] }) }), _jsx("div", { className: "member-grid sidebar-members", children: visibleMembers.map((member) => (_jsxs("div", { className: "member-card", children: [_jsxs("div", { children: [_jsx("strong", { children: member.displayName }), _jsx("span", { children: member.role })] }), _jsx("strong", { children: formatSignedMoney(member.balance) })] }, member.id))) })] })] }), _jsxs("section", { className: "main-stack", children: [_jsxs("article", { className: "panel create-panel", children: [_jsxs("div", { className: "panel-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "kicker", children: "Hidden market" }), _jsx("h2", { children: "Launch a new thesis" })] }), selectedGroup ? _jsxs("span", { className: "subtle-copy", children: ["Live in ", selectedGroup.name] }) : null] }), _jsxs("form", { onSubmit: handleCreateMarket, className: "create-market-grid", children: [_jsxs("select", { value: targetUserId, onChange: (event) => setTargetUserId(event.target.value), required: true, children: [_jsx("option", { value: "", children: "Choose who the market is about" }), _jsx("option", { value: GENERAL_MARKET_VALUE, children: "General" }), selectedGroup?.members
                                                        .filter((member) => member.id !== profile?.user.id)
