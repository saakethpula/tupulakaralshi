...
export default function App() {
    ...
    if (showOnboarding) {
        return (
            <OnboardingScreen
                ...
                needsVenmoHandle={needsVenmoHandle}
                ...
                tutorialAmountNumber={tutorialAmountNumber}
                tutorialPracticeStep={tutorialPracticeStep}
                tutorialHoverTarget={tutorialHoverTarget}
                setTutorialHoverTarget={setTutorialHoverTarget}
                tutorialBetPlaced={tutorialBetPlaced}
                tutorialPrompt={tutorialPrompt}
                tutorialVenmoUrl={tutorialVenmoUrl}
                onTutorialSideChange={handleTutorialSideChange}
                onTutorialAmountChange={handleTutorialAmountChange}
                onTutorialPlaceBet={handleTutorialPlaceBet}
                onTutorialPaymentSent={handleTutorialPaymentSent}
    ...
    return (
        <DashboardScreen
            ...
            familyManagerOpen={familyManagerOpen}
            setFamilyManagerOpen={setFamilyManagerOpen}
