...
export function MarketCard({ market, profile, selectedGroupRole, maxBet, busyAction, draft, onUpdateTradeDraft, onSavePosition, onResolveMarket, onConfirmMarketResolution, onDeleteMarket, onMarkPayoutSent, onRespondToPayout }) {
